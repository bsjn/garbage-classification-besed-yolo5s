...
def parse_opt(known=False):
    ...
    parser.add_argument("--cfg", type=str, default="5s_garbage.yaml", help="model.yaml path")
    parser.add_argument("--data", type=str, default=ROOT / "data1/garbage.yaml", help="dataset.yaml path")
